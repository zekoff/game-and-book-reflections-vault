...
I haven’t yet spent any time (other than the demo) with City Trials. I was ambivalent about this mode during the demo. There is heavy reliance on combat, which itself relies on the Quick Spin, which itself is a source of irritation for me because it requires a stick wiggle. I looked in the options for a way to map the Quick Spin to a button but couldn’t find that option if it exists.

I’m not yet in love with this game. I have returned to it a few times since I’ve purchased it. I’ll likely keep going back from time to time at least for a little while. Mostly I think that’s because of how quickly races can be completed.
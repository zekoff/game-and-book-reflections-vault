...
I appreciate the realtime with pause approach. Units can be deployed while a ticker advances them which keeps things snappy. The game can also be paused and the units can be placed and then the simulation advanced one unit of time. There is usually a weakness in realtime with pause. To play optimally I feel like I must pause frequently so that I can micromanage them. And if I simply let things play out instead, then I know I’m sacrificing optimal play. I’m unhappy no matter which I choose. (I love realtime with pause, just highlighting a tension.)